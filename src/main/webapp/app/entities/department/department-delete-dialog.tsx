...
export const DepartmentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="j28PostgresApp.department.delete.question">
        <Translate contentKey="j28PostgresApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
