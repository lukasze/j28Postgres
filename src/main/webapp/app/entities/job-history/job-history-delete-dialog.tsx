...
export const JobHistoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="j28PostgresApp.jobHistory.delete.question">
        <Translate contentKey="j28PostgresApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
